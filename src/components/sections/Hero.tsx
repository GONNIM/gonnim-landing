const CAL_URL = "https://cal.com/gonnim/30min";
...
export function Hero() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      />
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-10 px-6 pt-24 pb-20 text-center sm:pt-32 sm:pb-28 md:px-8">
